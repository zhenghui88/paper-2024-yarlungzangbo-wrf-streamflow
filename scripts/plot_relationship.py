...
for igauge, gauge in enumerate(gaugelist):
    ...
    rank_kge_info[gauge]["streamflow_best"]["statistic"] = res.statistic  # type: ignore
    rank_kge_info[gauge]["streamflow_best"]["pvalue"] = res.pvalue  # type: ignore
    ...
    res = stats.spearmanr(x, y)
    rank_kge_info[gauge]["runoff"]["statistic"] = res.statistic  # type: ignore
    rank_kge_info[gauge]["runoff"]["pvalue"] = res.pvalue  # type: ignore
    xrank = len(SELECTED_EXPS) + 1 - stats.rankdata(x, method="ordinal")
    yrank = len(SELECTED_EXPS) + 1 - stats.rankdata(y, method="ordinal")
    for ii, (xx, yy, ee) in enumerate(zip(xrank, yrank, SELECTED_EXPS)):
    ...
    res = stats.spearmanr(x, y)
    rank_kge_info[gauge]["precipitation"]["statistic"] = res.statistic  # type: ignore
    rank_kge_info[gauge]["precipitation"]["pvalue"] = res.pvalue  # type: ignore
...
for igauge, gauge in enumerate(gaugelist):
    ...
    res = stats.spearmanr(x, y)
    rank_rho_info[gauge]["streamflow_best"]["statistic"] = res.statistic  # type: ignore
    rank_rho_info[gauge]["streamflow_best"]["pvalue"] = res.pvalue  # type: ignore
    xrank = len(SELECTED_EXPS) + 1 - stats.rankdata(x, method="ordinal")
    yrank = len(SELECTED_EXPS) + 1 - stats.rankdata(y, method="ordinal")
    for ii, (xx, yy, ee) in enumerate(zip(xrank, yrank, SELECTED_EXPS)):
        ax.plot(
    ...
    res = stats.spearmanr(x, y)
    rank_rho_info[gauge]["runoff"]["statistic"] = res.statistic  # type: ignore
    rank_rho_info[gauge]["runoff"]["pvalue"] = res.pvalue  # type: ignore
    xrank = len(SELECTED_EXPS) + 1 - stats.rankdata(x, method="ordinal")
    yrank = len(SELECTED_EXPS) + 1 - stats.rankdata(y, method="ordinal")
    for ii, (xx, yy, ee) in enumerate(zip(xrank, yrank, SELECTED_EXPS)):
        ax.plot(xx, yy, "P", color=plt.color_sequences["tab20"][ii])
    ...
    res = stats.spearmanr(x, y)
    rank_rho_info[gauge]["precipitation"]["statistic"] = res.statistic  # type: ignore
    rank_rho_info[gauge]["precipitation"]["pvalue"] = res.pvalue  # type: ignore
    xrank = len(SELECTED_EXPS) + 1 - stats.rankdata(x, method="ordinal")
    yrank = len(SELECTED_EXPS) + 1 - stats.rankdata(y, method="ordinal")
    for ii, (xx, yy, ee) in enumerate(zip(xrank, yrank, SELECTED_EXPS)):
    ...
    res = stats.spearmanr(x, y)
    rank_rho_info[gauge]["precipitations_spatial"]["statistic"] = res.statistic  # type: ignore
    rank_rho_info[gauge]["precipitations_spatial"]["pvalue"] = res.pvalue  # type: ignore
    xrank = len(SELECTED_EXPS) + 1 - stats.rankdata(x, method="ordinal")
    yrank = len(SELECTED_EXPS) + 1 - stats.rankdata(y, method="ordinal")
    for ii, (xx, yy, ee) in enumerate(zip(xrank, yrank, SELECTED_EXPS)):
        ax.plot(xx, yy, "^", color=plt.color_sequences["tab20"][ii])
